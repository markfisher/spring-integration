 ...
 * @since 2.0
 */
public class SimpleHttpHeaderMapper {// extends AbstractHeaderMapper<HttpHeaders> implements BeanFactoryAware, InitializingBean {

	private static final Log logger = LogFactory.getLog(SimpleHttpHeaderMapper.class);
	 ...
	 * {@link SimpleHttpHeaderMapper#setUserDefinedHeaderPrefix(String)}. The default is 'X-'.
	 */
	 ...
	 */
	public static SimpleHttpHeaderMapper outboundMapper() {
		SimpleHttpHeaderMapper mapper = new SimpleHttpHeaderMapper();
	 ...
	 */
	public static SimpleHttpHeaderMapper inboundMapper() {
		SimpleHttpHeaderMapper mapper = new SimpleHttpHeaderMapper();
...
/*
	@Override
	protected Map<String, Object> extractInboundStandardHeaders(HttpHeaders source) {
		return null;
	}

	@Override
	protected Map<String, Object> extractInboundUserDefinedHeaders(HttpHeaders source) {
		return null;
	}

	@Override
	protected void populateOutboundStandardHeaders(MessageHeaders headers, HttpHeaders target) {
		if (logger.isDebugEnabled()) {
	...
	@Override
	protected void populateOutboundUserDefinedHeader(String headerName, Object headerValue, HttpHeaders target) {
	}
*/
}
